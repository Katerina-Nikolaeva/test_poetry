...
def mask_account_card(account_card: str) -> str:
    ...
    Parameters:
      - account_card (str): тип и номер карты или счета. Примеры: Visa Platinum 7000792289606361, Счет 73654108430135874305.

    Returns:
      - (str): Замаскированный номер карты или счета. Примеры: Visa Platinum 7000 79** **** 6361, Счет **4305.
    """
    masked_account_card = ""
