def get_mask_card_number(card_number: str) -> str:
    ...
    Parameters:
      - card_number (str): Номер банковской карты. Пример: 7000792289606361

    Returns:
      - (str): Замаскированный номер карты, разделенный на блоки по 4 цифры. Пример: 7000 79** **** 6361
    """
...
def get_mask_account(account_number: str) -> str:
    ...
    Parameters:
      - account_number (str): Номер банковского счета. Пример: 73654108430135874305

    Returns:
      (str): Замаскированный номер банковского счета. Пример: **4305
    """
